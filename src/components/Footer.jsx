    ...
    <footer className="bg-[#1a2e1a] text-white py-10 mt-10">
      <div className="max-w-6xl mx-auto px-4 flex flex-col items-center gap-6">
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold tracking-wide">KinKeeper</h2>
          <p className="text-sm text-gray-400 mt-1">Your personal shelf of meaningful connections. Browse, tend, and nurture the relationships that matter most</p>
        </div>
